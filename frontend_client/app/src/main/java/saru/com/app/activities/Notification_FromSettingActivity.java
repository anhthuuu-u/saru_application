...
public class Notification_FromSettingActivity extends AppCompatActivity {
    ...
    private TextView txtNotification_system;
    private TextView txtNotification_order;
    private TextView txtNotification_discount;
    ...
    private void addViews() {
        ...
        emptyView.setText("No system notifications available");
                ...
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        ...
                        if (task.getResult().isEmpty()) {
                            Log.d(TAG, "No system notifications found for AccountID: " + accountID);
                            ...
                            if (validNotificationCount > 0) {
                                ...
                                Log.d(TAG, "Valid system notifications loaded: " + validNotificationCount +
                                        " for AccountID: " + accountID);
                            } else {
                                Log.w(TAG, "No valid system notifications found after filtering for AccountID: " + accountID);
                            }
                        }
                        updateSelectAllCheckbox();
                    } else {
                        Log.e(TAG, "Error fetching system notifications: ", task.getException());
